  ...
  ***********************************************************/
  ...
  localparam  S_IDLE            =   8'd0,
    ...
    begin
        ...
        S_RST_AXIDMA:
            write_state_str = "RST_AXIDMA";
        S_WRITE_DMACR:
            write_state_str = "WRITE_DMACR";
        S_WRITE_SA:
  ...
  begin
    ...
    S_RST_AXIDMA:
    begin
      axi_awaddr    = MM2S_DMACR_ADDR;    //复位AXI_DMA
      axi_wdata[2]  = 1'b1;
    end
    S_WRITE_DMACR:
    begin      
    ...
    begin
      axi_awaddr    = MM2S_SA;
      axi_wdata     = 32'h3000_1000;       //写入DDR源地址
    end    
    S_WRITE_SA_MSB:
    begin      
    ...
    S_WRITE_LENGTH:
    begin
      axi_wdata[22:0] = 23'd1024;         //写入长度1024Bytes
      axi_awaddr      = MM2S_LENGTH;
    end    
    S_START_DMA:
    begin      
      axi_wdata[0]  = 1'b1;               //开始DMA传输
      axi_awaddr    = MM2S_DMACR_ADDR;
    end    
    S_WAIT_DONE:                          //等待传输完成
      ;
