...
`define     CAL_BASE_ADDR               24'h100000
`define     CON_BASE6_ADDR              24'h300000
`define     CON_BASE_ADDR               24'h200000

//`define     TC_TAB_NUM                  24'd20000
//`define     RTD_TAB_NUM                 24'd240000


`define     WR_KB_CS                     3'b100
`define     WR_TEMPBND_CS                3'b010
`define     WR_TEMPDATA_CS               3'b001
...
`define     IO_LEN                  8'd54   // IO or COM1 data packet length , 128B/2 = 64
...
`define     RTD_TYPE                5'd5     // RTD type number
`define     TC_TYPE                 5'd4     // TC type number
// packt type definition
`define     CFG_TYPE                16'h1122 // configration packt type
`define     CFG_FB_TYPE             16'h3344 // configration feedback packt type
`define     MT_TYPE                 16'h5566 // maintain packt type
