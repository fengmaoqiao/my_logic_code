...
`define     WR_DEBUG_CS                 3'b100
`define     WR_CON_CS                   3'b010
`define     WR_CHN_CS                   3'b001

`define     RD_DEBUG_CS                 4'b1000
`define     RD_STU_CS                   4'b0100
`define     RD_CHN_CS                   4'b0010
`define     RD_DGD_CS                   4'b0001
