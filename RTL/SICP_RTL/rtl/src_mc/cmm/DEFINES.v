...
`define     STA_DATA_LEN            16'd72   // status packet length , 328B
...
`define     STA_LEN                 11'd36   // status packet length , 328B/2 = 164 
`define     COLL_LEN                11'd40   // collection packet length , 328B/2 = 164 

// board type definition
`define     AI_TYPE                 5'd2     // AI type number
`define     AO_TYPE                 5'd6     // AO type number
`define     DI_TYPE                 5'd3     // DI type number
`define     DO_TYPE                 5'd7     // DO type number
`define     COM1_TYPE               5'd8     // COM1 type number
`define     COM2_TYPE               5'd9     // COM2 type number
`define     COM3_TYPE               5'd10    // COM3 type number
`define     MPU_TYPE                5'd1     // MPU type number
`define     EX_TYPE                 4'd11    // EX type number
`define		COM4_TYPE				4'd12	 //	COM4 type number
